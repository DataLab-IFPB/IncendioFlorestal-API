export class Chart {
  ...
  private generateChart(
    ...
    const dataset = this.factoryDatasetChart(
      rotulo,
      dados,
      borderColor,
      backgroundColor
  ...
  doubleLineChart(titulo: string, dados: any[]) {
    const dataset01 = this.factoryDatasetChart(
      dados[0].rotulo,
      dados[0].dataset,
      this.cores.red,
      this.cores.red
    );
    const dataset02 = this.factoryDatasetChart(
      dados[1].rotulo,
      dados[1].dataset,
      this.cores.blue,
      this.cores.blue
    );
    return this.factoryChart(titulo, 'line', this.labelsMeses, [
      dataset01,
      dataset02,
    ]);
  }
  ...
  comboChart(titulo: string, dados: any[]) {
    ...
    const dataset03 = this.factoryDatasetChart(
      dados[2].rotulo,
      dados[2].dataset,
      this.cores.purple,
      this.cores.purple
    ...
    return this.factoryChart(titulo, 'bar', this.labelsMeses, [
      dataset03,
      dataset02,
      dataset01,
    ]);
